...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* ---------- Seguradoras (marquee) ---------- */
  const insurers = [
    { name: "Porto Seguro", src: "images/parceiros/porto.webp" },
    { name: "Itaú Seguros", src: "images/parceiros/itau.webp" },
    { name: "Azul Seguros", src: "images/parceiros/azul.png" },
    { name: "Tokio Marine", src: "images/parceiros/tokio.webp" },
    { name: "HDI Seguros", src: "images/parceiros/hdi.webp" },
    { name: "Zurich Seguros", src: "images/parceiros/zurich.webp" },
    { name: "Mapfre Seguros", src: "images/parceiros/mapfre.webp" },
    { name: "Yelum Seguros", src: "images/parceiros/yelum.webp" },
    { name: "Allianz Seguros", src: "images/parceiros/allianz.webp" },
    { name: "Mitsui Seguros", src: "images/parceiros/mitsui.webp" },
    { name: "Bradesco Saúde", src: "images/parceiros/bradescosaude.webp" },
    { name: "Amil", src: "images/parceiros/amil.webp" },
    { name: "Notredame", src: "images/parceiros/notredame.webp" },
